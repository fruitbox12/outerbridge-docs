...
<br />
<img src="/node-parameters.gif" alt="simplifi Node Parameters" height="auto" width='100%'></img>
...
| inputParameters `(optional)`   		| String    													| Description of additional parameter needed for this option. See [inputParameters example](https://github.com/simplifiio/simplifi/blob/master/packages/components/src/ETHOperations.ts)                                                                                                                                    
| exampleParameters `(optional)`   		| String    													| Example of additional parameter needed for this option. See [exampleParameters example](https://github.com/simplifiio/simplifi/blob/master/packages/components/src/ETHOperations.ts)                                                                                                                                  
| exampleResponse `(optional)`   		| Object    													| Example of output response for this option. See [exampleResponse example](https://github.com/simplifiio/simplifi/blob/master/packages/components/src/ETHOperations.ts)                                                                                                                                      
...
| hideRegisteredCredential `(optional)`	| Boolean 														| Only used on `credentialMethod` option to hide registeredCredentials. See [hideRegisteredCredential example](https://github.com/simplifiio/simplifi/blob/master/packages/components/nodes/HTTP/HTTP.ts#L88)  
...
```
<br />
<img src="/input-string.png" alt="simplifi Input String" height="auto" width='max-content'></img>
...
```
<br />
<img src="/input-number.png" alt="simplifi Input Number" height="auto" width='max-content'></img>
...
```
<br />
<img src="/input-options.png" alt="simplifi Input Options" height="auto" width='max-content'></img>
...
```
<br />
<img src="/async-options.gif" alt="simplifi Async Options" height="auto" width='max-content'></img>
...
```
See `ContractEventTrigger.ts` [example](https://github.com/simplifiio/simplifi/blob/master/packages/components/nodes/ContractEventTrigger/ContractEventTrigger.ts#L62)
...
```
<br />
<img src="/input-array.png" alt="simplifi Input Array" height="auto" width='max-content'></img>

See `Scheduler.ts` [example](https://github.com/simplifiio/simplifi/blob/master/packages/components/nodes/Scheduler/Scheduler.ts#L48)
...
```
<br />
<img src="/input-password.png" alt="simplifi Input Password" height="auto" width='max-content'></img>
...
```
<br />
<img src="/input-json.png" alt="simplifi Input Json" height="auto" width='max-content'></img>
...
```
<br />
<img src="/input-code.png" alt="simplifi Input Code" height="auto" width='max-content'></img>
...
```
<br />
<img src="/input-date.png" alt="simplifi Input Date" height="auto" width='max-content'></img>
...
```
<br />
<img src="/input-file.png" alt="simplifi Input File" height="auto" width='max-content'></img>
...
```
<br />
<img src="/input-folder.png" alt="simplifi Input Folder" height="auto" width='max-content'></img>
