...
## Step 1
Go to `simplifi/packages/components/nodes`, create a folder `MinedBlockTrigger`. Inside the folder create a file `MinedBlockTrigger.ts`.
...
<br />
<img src="/create-trigger-node.gif" alt="simplifi Mined Block Trigger" height="auto" width='100%'></img>
